 ...
 * @author basith
 */
public class InputMinuman extends javax.swing.JFrame {
modelInput modell = new modelInput();
public DefaultTableModel tblmodel;
   String header[] = {"kode_minuman", "nama_minuman","stok", "harga"};


    
    public InputMinuman() throws SQLException{
        initComponents();
 ...
 * 
    ...
    try {
        ...
        Logger.getLogger(InputMinuman.class.getName()).log(Level.SEVERE, null, ex);
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new InputMinuman().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(InputMinuman.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
